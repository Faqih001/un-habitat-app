...
const setupDatabase = require('./setup-database'); // Import the setup-database module
...
async function run() {
  ...
  if (setupSuccess) {
    ...
    if (importSuccess) {
      ...
      console.error('\n=== IMPORT FAILED ===');
      console.log('The database was set up, but data import failed. Check the errors above.');
    }
  } else {
    console.error('\n=== SETUP FAILED ===');
    console.log('Database setup failed. Import was not attempted. Check the errors above.');
  }
}
